...
WORK_DIR="${WORK_DIR:-work_dirs/ssr_loss1_latent_noise_g123_12ep}"
CFG="${CFG:-projects/configs/SSR/SSR_e2e_latent_noise_12ep_g123.py}"
...
METHOD_NAME="${METHOD_NAME:-Loss改进-1 (latent_noise)}"
COMMENT_NOTE="${COMMENT_NOTE:-自动追加（GPU0,1,2,3；latent_noise 12ep）}"
