...
WORK_DIR="work_dirs/ssr_stage2_l2best_balancedloss_3ep"
CFG="projects/configs/SSR/SSR_e2e_stage2_l2best_balancedloss_3ep.py"
EVAL_CFG="projects/configs/SSR/SSR_e2e_corruptions_eval.py"
CSV_PATH="work_dirs/paper_metrics_all_ema_unified.csv"
GPU_IDS="0,1,2,3"
NUM_GPUS=4
TARGET_EPOCH=3

NUSC_INFO="data/nuscenes/vad_nuscenes_infos_temporal_val.pkl"
FOG3_INFO="data/corruptions/vad_nuscenes_infos_temporal_val_fog3_cam.pkl"

METHOD_NAME="阶段2损失再平衡 (risk0.55+trajrisk0.08 3ep)"
COMMENT_NOTE="自动追加（GPU0,1,2,3；tmux pipeline）"
