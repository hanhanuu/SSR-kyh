...
def main():
    ...
    if cfg.get('model', None) is not None:
        cfg.model = _strip_cfg_keys(cfg.model, {'ann_file', 'map_ann_file'})
    if cfg.get('train_cfg', None) is not None:
        cfg.train_cfg = _strip_cfg_keys(cfg.train_cfg, {'ann_file', 'map_ann_file'})
    if cfg.get('test_cfg', None) is not None:
        cfg.test_cfg = _strip_cfg_keys(cfg.test_cfg, {'ann_file', 'map_ann_file'})
